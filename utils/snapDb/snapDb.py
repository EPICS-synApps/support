...
class TopFrame(wx.Frame):
	...
	def fillMainPanel(self):
		...
		infoPanel = wx.Panel(topPanel)
		infoPanelSizer = wx.BoxSizer(wx.HORIZONTAL)
		infoPanel.SetSizer(infoPanelSizer)

		infoLeftPanel = wx.Panel(infoPanel)
		infoLeftPanelSizer = wx.BoxSizer(wx.VERTICAL)
		infoLeftPanel.SetSizer(infoLeftPanelSizer)
		textLeft1 = wx.StaticText(infoLeftPanel, -1, ".dbd File:")
		textLeft2 = wx.StaticText(infoLeftPanel, -1, "displayInfo File:")
		infoLeftPanelSizer.Add(textLeft1, 0, wx.LEFT|wx.TOP, 5)
		infoLeftPanelSizer.Add(textLeft2, 0, wx.LEFT|wx.BOTTOM, 5)

		infoRightPanel = wx.Panel(infoPanel)
		infoRightPanelSizer = wx.BoxSizer(wx.VERTICAL)
		infoRightPanel.SetSizer(infoRightPanelSizer)
		textRight1 = wx.StaticText(infoRightPanel, -1, "%s" % self.dbdFileName)
		textRight2 = wx.StaticText(infoRightPanel, -1, "%s" % self.displayInfoFileName)
		infoRightPanelSizer.Add(textRight1, 0, wx.RIGHT|wx.TOP, 5)
		infoRightPanelSizer.Add(textRight2, 0, wx.RIGHT|wx.BOTTOM, 5)

		infoPanelSizer.Add(infoLeftPanel, 0, wx.LEFT|wx.TOP, 5)
		infoPanelSizer.Add(infoRightPanel, 0, wx.LEFT|wx.TOP, 5)
		topPanelSizer.Add(infoPanel, 0, wx.LEFT|wx.TOP, 5)
		...
		addRecordText = wx.StaticText(rap, -1, "add new record:")
		addRecordTextCtrl = wx.TextCtrl(rap, -1, "", size=(200,-1), style=wx.TE_PROCESS_ENTER)
		rapSizer.Add(addRecordText, 0, 0)
		rapSizer.Add(addRecordTextCtrl, 1, 0)
		rap.SetSizer(rapSizer)
		self.Bind(wx.EVT_TEXT_ENTER, self.addRecordName, addRecordTextCtrl)
		...
		rapSizer = wx.BoxSizer(wx.VERTICAL)
		addReplacementsText = wx.StaticText(rap, -1, "add new replacement string\n(e.g., 'xxx=abc')")
		addReplacementsTextCtrl = wx.TextCtrl(rap, -1, "", style=wx.TE_PROCESS_ENTER)
		rapSizer.Add(addReplacementsText, 0, wx.EXPAND|wx.RIGHT, 5)
		rapSizer.Add(addReplacementsTextCtrl, 1, wx.EXPAND|wx.RIGHT, 5)

		rap.SetSizer(rapSizer)
		self.Bind(wx.EVT_TEXT_ENTER, self.addReplacement, addReplacementsTextCtrl)
		replacementsPanelSizer.Add(rap, 0, wx.EXPAND|wx.ALL, 5)
...
def main():
	app = wx.PySimpleApp()
	frame = TopFrame(None, -1, 'snapDb', size=(800,400))
	#frame = TopFrame(None, -1, 'snapDb')
	frame.Center()
	(hS, vS) = frame.GetSize()
